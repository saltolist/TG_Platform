...
> **Шаг 4 (фаза 3):** если пост привязан к сообщению в канале
> (`data.telegramMessageId`) и меняется текст — бэкенд дополнительно вызывает
> Telethon `edit_message` в подключённом канале. Черновики без привязки к TG
> обновляются только в БД. См. [phase-3-telegram.md, шаг 4](phases/phase-3-telegram.md#шаг-4--публикация-планирование-и-правки-в-канал).
