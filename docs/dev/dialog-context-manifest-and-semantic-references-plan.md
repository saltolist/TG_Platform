...
> **Superseded для обычного read/generate-пути.** Актуальная архитектура
> описана в [плане упрощения диалогового контекста](smart-rag-dialog-context-simplification-plan.md).
> Этот документ остаётся историческим описанием provenance/freshness-контрактов;
> semantic referent resolver больше не является целевым runtime-путём.
