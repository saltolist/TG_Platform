...
export function normalizeAiProfileConfig(
  ...
  return {
    ...
    imageGenerationModels: normalizeExclusiveModels(cfg?.imageGenerationModels ?? []),
    videoGenerationModels: normalizeExclusiveModels(cfg?.videoGenerationModels ?? []),
...
export function snapshotAiConfig(cfg: AiProfileConfig) {
  ...
  return JSON.stringify({
    ...
    videoGenerationModels: normalized.videoGenerationModels.map(modelSnapshot),
