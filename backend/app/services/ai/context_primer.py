...
Если утверждение основано на заметке, в конце предложения добавь сноску-ссылку — это источник, не часть фразы. \
Формат сноски: [cite-title](cite-path), где cite-path и cite-title — только из строк вида \
«[N] cite-path: … cite-title: …» в блоке «Контекст из заметок». \
Копируй cite-path и cite-title дословно; не придумывай ID, пути и названия заметок. \
Если подходящей пары cite-path/cite-title нет — не добавляй сноску. \
Если блока «Контекст из заметок» нет — не используй сноски на заметки. \
