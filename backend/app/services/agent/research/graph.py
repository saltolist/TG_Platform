...
CONTEXT_SELECTOR_SYSTEM = (
    ...
    "Spanish sin identificar/indicar means absent. "
    "Atomic evidence must state the answer. Synthesis, comparison, classification, audit, "
    "contradiction, or planning may use concrete necessary premises: facts, constraints, relations, "
    "examples, or counterexamples. Lexical overlap or generic background is not. "
