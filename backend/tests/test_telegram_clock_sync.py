...
def test_offset_from_message_date_uses_utc_timestamp() -> None:
    message = SimpleNamespace(date=datetime(2026, 7, 3, 12, 0, 0, tzinfo=timezone.utc))
    with patch("app.services.telegram.clock_sync.time.time", return_value=1_783_037_600.0):
